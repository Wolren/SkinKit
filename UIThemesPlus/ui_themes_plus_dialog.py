...
def _gallery_entries():
    return [
        ("Light", "Light thene", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "light/light.qss")),
        ("Dark", "Dark theme", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "Dark/darkstyle.qss")),
        ("Minimalist", "Minimalist theme", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "Minimalist/minimalist.qss")),
        ("Dark Forest", "Deep forest tones", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "DarkForest.qss")),
        ("Orange Forest", "Orange forest tones", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "OrangeForest.qss")),
        ("Wombat", "Wombat theme", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "Wombat/stylesheet.qss")),
        ("Coffee", "Cofee theme", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "Coffee/coffee.qss")),
        ("Dark green", "Dark green theme", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "Dark Green (FreeCAD)/stylesheet.qss")),
        ("Light green", "Light green theme", os.path.join(
            os.path.dirname(__file__), "builtin_themes", "Light Green (FreeCAD)/stylesheet.qss")),
    ]
...
class UIThemesPlusDialog(QDialog):
    ...
    def _load_gallery(self, name, qss_path):
        if qss_path and os.path.isfile(qss_path):
            ...
            self.qss_editor.setPlainText(
                f"/* Could not locate style.qss for '{name}'. */\n"
                f"/* Themes folder reported by QGIS: "
                f"{QgsApplication.defaultThemesFolder() or '(none)'} */\n"
            )
    ...
    def _tab_font(self):
        ...
        self.font_sz.setSpecialValueText("(keep default)"); form.addRow("Font size (pt):", self.font_sz); return w
